...
**Generator code for 418 projects.** A generator plus a seed is everything
...
each project: those 418 are about 1.5% of the catalog and account for **71.5%**
of everything ever spent on the platform.

One 300x300 preview per archived project is stored too — WebP, 10 MB for all 418
...
The artist's `index.html` is never modified, and the other 362 projects run it
...
- **The real long-term risk is IPFS, not fxhash.** The blockchain records who
  ...
  unretrievable. Every seed is now held here, and 418 projects have their code
...
- **Unofficial and unaffiliated.** Nothing here is endorsed by fxhash or by the
  ...
  from IPFS and the Tezos chain as you view them. The exception is the 418
...
- **Archived generator code** — `public/data/generators/` holds the actual
  programs written by the artists behind 418 projects, copied from IPFS and from
