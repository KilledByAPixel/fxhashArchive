...
async function main() {
  const { tokens, collaborations, thumbs, volumes, sizes } = await readArchiveInputs(DATA)
  const gallery = buildGallery({ tokens, collaborations, volumes, sizes, generatedAt: new Date().toISOString() })
