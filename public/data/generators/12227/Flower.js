class Flower {
  constructor(x, y) {
    ...
    this.stemtop = random(45, 55) * scgrass * 0.45;
  ...
  spawn() {
    if (hasflowers > 0.2) {
      ...
      for (this.i = 0; this.i <= this.steps; this.i++) {
        ...
        this.pedallength = int((random(4, 5) * scgrass) / 3.5);
        this.flowerscale = int((random(4, 12) * scgrass) / 3.5);
